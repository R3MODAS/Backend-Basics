const Product = ({_id, title,thumbnail,price,discountPercentage,rating, handleDeleteProduct}) => {
              ...
              <div className="image-container">
                <div className="first">
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <span className="wishlist" onClick={() => handleDeleteProduct(_id)}>
                ...
                <img
                  src={thumbnail}
                  className="rounded thumbnail-image"
                  alt={title}
                />
              </div>
